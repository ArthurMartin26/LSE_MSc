...
## Marriage status / relationship status 

v501  - Current marital status (1=married, 2= in a union)

## views on sex / reproductive autonomy 
 
v632 - Women can refuse sex with husband 
v633a - Women can ask husband to use a condom
...
v739 - person who usually decides how to spend respondent's earning
v741 - type of earning of a person (cash etc..) 

## mobility / social independence 

v467b getting medical help for self: getting permission to go
v467c getting medical help for self: getting money for needed treatment 
v467d getting medical help for self: distance to medical facility 
...
recode v157 3=2, gen(read) 		// Most countries do not have the category "almost everyday"(3), so we recoded it to "At least once a week"(2).
