...
4) [MED/HARD] link previous clusters to new clusters based off long and lat coordinates (use a nearest neighbour aproach probs 5/10 km) to create a psuedo panel.
